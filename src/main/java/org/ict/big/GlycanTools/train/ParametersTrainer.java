...
public class ParametersTrainer {
    ...
    static String spectraBaseFolder = "./input-spectra/Top5/";
    ...
    public static void train(){
        ...
        // get all alpha
        ArrayList<Double> allAlphas = ParametersGenerator.generateAlphaInTanh(0.01, 1.009, 0.01);
...
//                Print.pl("\tFilter spectrum: "+peakList.toTitleString());
    ...
    public static void writeTrainingResultToFile(ArrayList<ArrayList<ScoreAndRank>> trainingScores,
        ...
        try (Writer writer = new BufferedWriter(new OutputStreamWriter(
                new FileOutputStream("./trainedScores.txt"), "utf-8"))) {
